...
import com.tgarasanin.smack.Utilities.URL_GET_USER
import com.tgarasanin.smack.Utilities.URL_LOGIN
...
object AuthService {
    ...
    fun createUser(context: Context, name: String, email: String, avatarName: String, avatarColor: String, complete: (Boolean) -> Unit) {
        ...
        val createUserRequest = object : JsonObjectRequest(Method.POST, URL_LOGIN, null, Response.Listener { response ->
            try {
